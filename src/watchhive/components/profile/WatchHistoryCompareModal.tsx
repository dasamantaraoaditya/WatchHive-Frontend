    ...
    useEffect(() => {
        ...
        const fetchCompareData = async () => {
            ...
            try {
                ...
                const msg = err.response?.data?.error || 'Failed to compare watch histories due to privacy settings.';
                setError(msg);
            } finally {
                setLoading(false);
            }
            ...
            <div className="flex flex-col gap-6 py-2 min-h-[420px] max-h-[75vh] overflow-y-auto no-scrollbar font-display">
                {loading ? (
                    ...
                    <div className="py-16 text-center px-6">
                        <div className="w-16 h-16 rounded-full bg-rose-50 border border-rose-100 flex items-center justify-center text-3xl mx-auto mb-4">
                            🔒
                        </div>
                        <h4 className="text-lg font-black text-[#2D2926] mb-2">Access Restricted</h4>
